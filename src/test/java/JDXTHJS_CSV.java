...
public class JDXTHJS_CSV {
    public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        for (int x = 0; x < 100; x++) {
            ...
            ArrayList<ArrayList<ArrayList<String>>> res = joinquery.JDXTHJS_get_res(encRes.encRes, encRes.xtag_array);
        ...
        System.out.println("JDXTHJS average search_prepare time : " + searchprepare_all / Math.pow(10, 6 + 2) + " ms");
