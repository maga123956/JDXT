...
public class JDXTEMM_CSV {
    public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        System.out.println("---------- JDXTEMM setup ------------");
        ...
        System.out.println("JDXTEMM average decrypt time : " + decrypt_all / Math.pow(10, 6 + 2) + " ms");
        System.out.println("JDXTEMM average server time : " + server_all / Math.pow(10, 6 + 2) + " ms");
        System.out.println("JDXTEMM average search_prepare time : " + searchprepare_all / Math.pow(10, 6 + 2) + " ms");
        System.out.println("JDXTEMM average token and prior time : " + tokenprior_all / Math.pow(10, 6 + 2) + " ms");
